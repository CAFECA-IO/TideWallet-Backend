...
./node_modules/.bin/sequelize db:migrate:undo:all --env development --config ./env.bitcoin_cash_mainnet.js --migrations-path ./src/database/migrations --models-path ./src/database/models
fi
if [ -f ./env.bitcoin_cash_testnet.js ]; then
./node_modules/.bin/sequelize db:migrate:undo:all --env development --config ./env.bitcoin_cash_testnet.js --migrations-path ./src/database/migrations --models-path ./src/database/models
fi
