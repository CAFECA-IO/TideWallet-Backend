...
class Bot {
  ...
  find({ key }) {
    ...
    return new Promise((resolve) => {
      ...
      }).on('data', ({ key: dataKey, value }) => {
        rs.push({ key: dataKey, value });
      }).on('end', () => {
        resolve(rs);
      });
    });
    ...
    return new Promise((resolve, reject) => {
      if (Array.isArray(ops)) {
        ...
        ops.forEach((item) => {
          ...
          if (Object.prototype.hasOwnProperty.call(item, 'type') && Object.prototype.hasOwnProperty.call(item, 'key') && Object.prototype.hasOwnProperty.call(item, 'value')) {
